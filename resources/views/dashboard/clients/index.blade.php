        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="card">
                    ...
                    <h3 class="card-title">@lang('dashboard.clients') <small> "{{$clients->total()}}"</small></h3>
                    ...
                    <!-- /.card-header -->
                    <div class="card-body">
                        <a  href="{{route('dashboard.clients.create')}}" class=" btn-lg btn-info "><i class="fas fa-plus"></i> @lang('dashboard.add')</a>
                      <table class="mt-3 table table-bordered">
                        ...
                        <tbody>
                            ...
                            <td>{{$client->id}}</td>
                                ...
                                <td><a href="{{route('dashboard.clients.orders.create', $client->id  )}}" class="btn btn-primary">@lang('dashboard.add_order')</a></td>
                                <td>
                                    @if (auth()->user()->hasPermission('update-clients'))

                                    <a class="btn btn-success" href="{{route('dashboard.clients.edit',$client->id)}}">@lang('dashboard.edit')</a>
                                    @else
                                    ...
                                    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            @lang('dashboard.confirm.content') @lang('dashboard.client')
                                            </div>
