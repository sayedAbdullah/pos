...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <h1>@lang('dashboard.edit_order')</h1>
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            ...
                            <form action="{{ route('dashboard.clients.orders.update', ['order' => $order->id, 'client' => $client->id]) }}" method="post">
                                ...
                                <h4>@lang('dashboard.total') : <span class="total-price">{{ number_format($order->total_price, 2) }}</span></h4>

                                <button class="btn btn-primary btn-block" id="form-btn"><i class="fa fa-edit"></i> @lang('dashboard.edit_order')</button>
                    ...
                    @if ($client->orders->count() > 0)
                        ...
                        <div class="box box-primary">
                            ...
                            <div class="box-header">
                                ...
                                <h3 class="box-title" style="margin-bottom: 10px">@lang('dashboard.previous_orders')
