...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('dashboard/plugins/select2/css/select2.min.css') }}">
      ...
      <link rel="stylesheet" href="{{ asset('dashboard/plugins/selectize.js/css/selectize.css') }}">
      <link rel="stylesheet" href="{{ asset('dashboard/plugins/selectize.js/css/selectize.default.css') }}">
    <!--- datatable css file ---->
...
<body class="hold-transition sidebar-mini layout-fixed text-capitalize">
    <div class="wrapper">
        <!-- Navbar -->
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu">
                    ...
                    <a  class="dropdown-item" tabindex="-1" rel="alternate" hreflang="{{ $localeCode }}" href="{{ LaravelLocalization::getLocalizedURL($localeCode, null, [], true) }}">
                        {{ $properties['native'] }}
                    </a>
                    @endforeach
                </div>
...
<script src="{{ asset('dashboard/plugins/selectize.js/js/standalone/selectize.min.js') }}"></script>
{{-- <script src="{{ asset('dashboard/plugins/selectize.js/js/index.js') }}"></script> --}}
...
<script src="{{ asset('dashboard/pickadate/picker.js') }}"></script>
<script src="{{ asset('frontend/pickadate/picker.date.js') }}"></script>
